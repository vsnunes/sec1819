...
public class IntentionToSellAlteredKey extends Operation {

    public IntentionToSellAlteredKey(ClientInterface ci, NotaryInterface ni) {
    ...
    public void execute() {
        ...
        try {
            ...
            cert.init("", new File(System.getProperty("project.user.private.path") +
                    2 + System.getProperty("project.user.private.ext")).getAbsolutePath());
