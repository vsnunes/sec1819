...
public class IntentionToSellTo3 extends Operation {

    public IntentionToSellTo3(ClientInterface ci, NotaryMiddleware ni) {
        super("IntentionToSellTo3", ci, ni);
    }
    ...
    public void execute() {
        ...
        try {
            ...
            notaryInterface.notariesToSend = 3;
