...
public class IntentionToSellTo2 extends Operation {

    public IntentionToSellTo2(ClientInterface ci, NotaryMiddleware ni) {
        super("IntentionToSellTo2", ci, ni);
    }
    ...
    public void execute() {
        ...
        try {
            ...
            notaryInterface.notariesToSend = 2;
