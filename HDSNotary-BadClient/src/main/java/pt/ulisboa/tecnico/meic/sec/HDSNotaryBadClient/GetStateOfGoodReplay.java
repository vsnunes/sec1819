...
public class GetStateOfGoodTampered extends Operation {

    public GetStateOfGoodTampered(ClientInterface ci, NotaryInterface ni) {
        super("GetStateOfGoodTampered", ci, ni);
    }
